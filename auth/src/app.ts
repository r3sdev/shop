...
import { generate2FARouter } from './routes/two-factor-auth/generate-2fa';
import { enable2FARouter } from './routes/two-factor-auth/enable-2fa';
import { disable2FARouter } from './routes/two-factor-auth/disable-2fa';
import { validate2FARouter } from './routes/two-factor-auth/validate-2fa';
